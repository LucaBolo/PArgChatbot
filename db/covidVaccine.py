...
class CovidVaccineGraph:
    ...
    def create_nodes(tx):
        ...
        result = tx.run('''CREATE (N1:arg {id:"n1", sentences: ["I am celiac",
                                    ...
                                    (N5:arg {id:"n5", sentences: ["I do not have any drug allergy",
                                    ...
                                    (N6:arg {id:"n6", sentences: ["I have a drug allergy",
                                    ...
                                    (N13:arg {id:"n13", sentences: ["I do not suffer from mastocytosis",
                                    ...
                                    (N14:arg {id:"n14", sentences: ["I suffer from mastocytosis",
                                                        "I am afflicted with mastocystosis",
                                                        "I have a condition called mastocystosis"]}),
                                    (N15:arg {id:"n15", sentences: ["I have experienced a serious anaphylaxis in the past",
