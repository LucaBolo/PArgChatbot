...
class CovidVaccineGraph:
    ...
    def create_nodes(tx):
        ...
        result = tx.run('''CREATE (N1:arg {id:"n1", class:"p", question:"Are you celiac?", sentences: ["I am celiac",
                                    ...
                                    (N2:arg {id:"n2", class:"n", question:"Are you celiac?", sentences: ["I do not have the celiac disease",
                                                        "I am not celiac",
                                                        "I do not suffer from the celiac disease",
                                                        "I am not afflicted with the celiac disease"]}),
                                    (N3:arg {id:"n3", class:"n", question:"Are you immunosuppressed?", sentences: ["I am not immunosuppressed",
                                                        "I do not suffer from immunosuppression",
                                                        "I am not afflicted with immunosuppression"]})-[n3n4:attack]->
                                    (N4:arg {id:"n4", class:"p", question:"Are you immunosuppressed?", sentences: ["I am immunosuppressed",
                                    ...
                                    (N5:arg {id:"n5", class:"n", question:"Do you have any drug allergy?", sentences: ["I do not have any drug allergy",
                                    ...
                                    (N6:arg {id:"n6", class:"p", question:"Do you have any drug allergy?", sentences: ["I have a drug allergy",
                                    ...
                                    (N7:arg {id:"n7", class:"n", question:"Do you have bronchial asthma?", sentences: ["I do not suffer from bronchial asthma",
                                                        "I don't have bronchial asthma",
                                                        "I've never had bronchial asthma",
                                                        "I am not afflicted with bronchial asthma"]})-[n7n8:attack]->
                                    (N8:arg {id:"n8", class:"p", question:"Do you have bronchial asthma?", sentences: ["I suffer from bronchial asthma",
                                                        "I have bronchial asthma",
                                                        "I am affected by bronchial asthma",
                                                        "I am afflicted with bronchial asthma"]}),
                                    (N9:arg {id:"n9", class:"p", question:"Do you have diabetes?", sentences: ["I suffer from diabetes",
                                                        "I am diabetic",
                                                        "I am affected by diabetes"]})-[n9n10:attack]->
                                    (N10:arg {id:"n10", class:"n", question:"Do you have diabetes?", sentences: ["I do not suffer from diabetes",
                                                        "I am not affected by diabetes",
                                                        "I am not diabetic",
                                                        "I don't have diabetes"]}),
                                    (N11:arg {id:"n11", class:"p", question:"Are you allergic to latex?", sentences: ["I suffer from latex allergy",
                                                        "I'm allergic to latex",
                                                        "I have a latex allergy",
                                                        "Latex causes me an allergic reaction"]})-[n11n12:attack]->
                                    (N12:arg {id:"n12", class:"n", question:"Are you allergic to latex?", sentences: ["I do not suffer from latex allergy",
                                    ...
                                    (N13:arg {id:"n13", class:"n", question:"Do you suffer from mastocytosis?", sentences: ["I do not suffer from mastocytosis",
                                    ...
                                    (N14:arg {id:"n14", class:"p", question:"Do you suffer from mastocytosis?", sentences: ["I suffer from mastocytosis",
                                                        "I am afflicted with mastocystosis",
                                                        "I have a condition called mastocystosis"]}),
                                    (N15:arg {id:"n15", class:"p", question:"Have you had anaphylactic reactions?", sentences: ["I have experienced a serious anaphylaxis in the past",
                                    ...
                                    (N16:arg {id:"n16", class:"n", question:"Have you had anaphylactic reactions?", sentences: ["I've never experienced a serious anaphylaxis",
